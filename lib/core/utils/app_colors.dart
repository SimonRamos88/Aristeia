...
class AppColors {
  ...
  final backgroundColor = Color.fromARGB(255, 253, 252, 255);
  ...
  //final backgroundDisabledColor = Color.fromARGB(141, 226, 121, 61);
  final textColor = const Color(0xff241001);
  final shadowColor = const Color(0xff241001);
  final disabledColor = const Color(0xffB3B3B3);
